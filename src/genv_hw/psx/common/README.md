# PlaySation based hardware core
...
<table>
	...
	<tr>
		<td> IO </td>
		<td> 
			<p>Controllers are partially implemented, but require advancements in the core input management system.</p>
			<p>SIO port is implemented and used as the primary debugging UART.</p>
			<p>PIO based UART is not implemented.</p>
		</td>
	</tr>
</table>