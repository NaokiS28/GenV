...
public:
    uint16_t id;
    uint8_t checksum = 0;
    inline uint8_t calcSum() { return PS1_MemoryCard_xor(this, structsize(-2)); }
};
...
public:
    ...
    char fileName[21];
    uint8_t checksum;
    inline uint8_t calcSum() { return PS1_MemoryCard_xor(this, structsize(-3)); }
};
...
public:
    uint32_t offset;
    uint8_t checksum;
    inline uint8_t calcSum() { return PS1_MemoryCard_xor(this, structsize(-4)); }
};
