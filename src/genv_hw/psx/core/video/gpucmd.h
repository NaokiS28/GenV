...
const GP1HorizontalRes GP1HorizontalResList[5] = {
    GP1_HRES_256,
    GP1_HRES_320,
    GP1_HRES_368,
    GP1_HRES_512,
...
const uint16_t GPURawHorizontalResolution[5] = {
    256,
    320,
    368,
    512,
...
const GP1VerticalRes GP1VerticalResList[2] = {
    GP1_VRES_256,
    GP1_VRES_512};

const uint16_t GPURawVerticalResolution[2] = {
    256,
    512};
